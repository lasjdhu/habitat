...
export const AnimatedChip = ({
  ...
  const expandedWidth = SCREEN_WIDTH - 240;
  ...
  >(() => {
    return {
      width: withSpring<number>(isActive ? expandedWidth : 48, {}),
      paddingHorizontal: interpolate(progress.value, [0, 1], [12, 8]),
  ...
  }, [isActive, expandedWidth, inActiveBackgroundColor, activeColor, progress]);
